...
<head>
  ...
  <title>Login - Insumos Medicos</title>
    ...
    <div class="container">
      <form class="form-login" action="dashboard.php">
        ...
        <div class="login-wrap">
          ...
          <br>
          <button class="btn btn-theme btn-block" href="dashboard.php" type="submit"><i class="fa fa-lock"></i> Registrar</button>
          <hr>
          
          <div class="registration">
            Todavia no tienes una cuenta?<br/>
