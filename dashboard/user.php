...
<head>
  ...
  <title>User/ Insumos medicos</title>
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Usuarios y Roles</h3>
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Usuario</h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $mostrar['codusu']; ?></td>
                        <td><?php echo $mostrar['nomusu']; ?></td>
                        <td><?php echo $mostrar['apeusu']; ?></td>
                        <td><?php echo $mostrar['emausu']; ?></td>
                        <td><?php echo $mostrar['codrol']; ?></td>
                    </tr>
        ...
        <div class="showback">
          <a href="registro.php">
          <button type="button" class="btn btn-primary btn-lg btn-block">Añadir un nuevo administrador</button>
                  </a>
        </div>
        <!-- /row -->
      </section>
