...
<head>
  ...
  <title>Grossman/ Insumos medicos</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Grossman</h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                    ...
                    <?php
                    $sql="SELECT * FROM producto WHERE laboratorio = 'GROSSMAN'";
