...
<head>
  ...
  <title>Registro/ Insumos medicos</title>
        ...
        ?></h5>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="reckbris.php">Reckbris</a></li>
		...
		<div class="content-page">
			<div>
				<section class="banner contenedor">
					<form action="../servicios/registeradmin.php" method="POST">
						<secrion class="banner_title">
							<h2>Registra al nuevo administrador</h2>
						</secrion>
