...
<head>
  ...
  <title>Mi perfil - Insumos Medicos</title>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>INSU<span>MOS</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="img/pain.png" class="img-circle" width="80"></a></p>
