...
<html>
<head>
	<title>Registro | Insumos Medicos Del Continente</title>
	<meta charset="utf-8">
					...
					<nav class="nav">
						<div class="nav_container">
							...
							<div class="nav_menu">
								...
								<a href="login.php" class="nav_item">Iniciar sesion</a>
			...
			<div>
				<section class="banner contenedor">
					<form action="servicios/register.php" method="POST">
						...
						<input type="text" name="nameusur" required="" pattern="[a-zA-Z]+" placeholder="Nombre (Solo letras)">
						<input type="text" name="apeusur" required="" pattern="[a-zA-Z]+" placeholder="Apellido (Solo letras)">
						<input type="text" name="emausur" required="" placeholder="Correo">
						<input type="password" name="pasusur" required="" minlength="6" maxlength="12" placeholder="Contraseña (min 6, max 12)">
						<input type="password" name="pasusu2r" required="" minlength="6" maxlength="12" placeholder="Confirmar contraseña (min 6, max 12)">
						<?php
							if (isset($_GET['er'])) {
								switch ($_GET['er']) {
									case '1':
									...
									case '3':
										...
										break;
									case '4':
										echo '<p>Ingresa un correo valido</p>';
										break;							
									default:
										break;
								}
						...
						<div class="txtrletra"><h4>¿Ya tienes cuenta?</h4></div>
						<a href="login.php"><div class="txtregistro"><p>Inicia sesion</p></div></a>
					</form>
				</section>
			</div>	
		</div>
